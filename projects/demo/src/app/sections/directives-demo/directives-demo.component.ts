...
import { NgHapticClickDirective, NgHapticTapDirective, NgHapticHoverDirective } from 'ng-haptics';

@Component({
  selector: 'app-directives-demo',
  standalone: true,
  imports: [SectionHeaderComponent, NgHapticClickDirective, NgHapticTapDirective, NgHapticHoverDirective],
  template: `
      ...
      <div class="grid sm:grid-cols-3 gap-4">
        ...
        <div class="glass rounded-xl p-5 space-y-3">
          <div class="flex items-center gap-2">
            <span class="text-xs font-mono text-violet-400 bg-violet-500/10 px-2 py-1 rounded">[ngHapticClick]</span>
          </div>
          ...
          <button
            ...
            ngHapticClick="success"
            (click)="log('ngHapticClick → success')"
          >
            Click me
          </button>
        </div>
